...
from necessary_functions import getAreaSecondMaxContour
from necessary_functions import getAreaMaxContour
...
def get_angle(color, org_img, r_w, r_h):
...
# 第5关：蓝色Π形门
def find_center_of_next(org_img, door_cnt, door_end, r_w, r_h):
